...
// guard. The bug that motivated these tests was discovered
// on 2026-06-15 during the Step 3.d.1 smoke test against a brand-
...
// Regression for : a brand-new live project with ZERO audit_events
