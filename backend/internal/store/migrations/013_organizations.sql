-- Migration 013: organizations + members + invites + projects.tenant_id ().
--
-- v0.1 of the multi-seat tenant model. This is the schema foundation
-- the Enterprise tier copy has promised since . Every Mesedi
