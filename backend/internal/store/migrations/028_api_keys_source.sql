...
-- SSO login and magic-link sign-in (commit 1 + 2).
--
-- Background. Before the dashboard only had ONE way in: paste an
...
--
-- adds two new dashboard sign-in paths: SSO via Google/GitHub and
