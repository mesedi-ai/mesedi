...
--
-- Mesedi . The existing lifecycle model assumes an execution
...
--                      enforcement (b) to subtract paused time
--                      from time-budget checks, and by the HITL
--                      SLA detectors (hitl_timeout, 
...
--                      detector () which fires when a single
