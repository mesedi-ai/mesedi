...
// feature (v1). See migrations/024_audit_events.sql for the
// schema rationale.
...
// rows whose project_deleted_at < cutoff (SOC 2 / financial-
...
// activity yet. Discovered during Step 3.d.1 smoke test
...
// version's doc comment for the bug history (Step 3.d.1, ).
