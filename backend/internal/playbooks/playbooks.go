...
//	  class-level catch-all (crashes/_default.md, ) walks the
...
var patterns = []pattern{
	...
	// ── Tier 1 commercial-value detectors (-, , ) ──
	...
	// ── Tier 2 failure-detection depth (-) ──────────
...
// content into Claude's prompt. When the binary ships with
