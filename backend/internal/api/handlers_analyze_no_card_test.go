// Unit tests for HandleAnalyzeFailureGroup's no-card gate (#210
...
//
// Why this test was missing in the original #209 ship:
...
func TestHandleAnalyze_Hobby_NoCard_Returns402(t *testing.T) {
	// The regression test for #210: this is the exact scenario
