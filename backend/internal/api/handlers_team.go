...
// Team / multi-seat handlers (Phase 3).
//
...
//   chain). The handler resolves project_id -> tenant_id
...
func (h *Handlers) HandleRemoveMember(w http.ResponseWriter, r *http.Request) {
	...
	// Last-admin protection (Robert flagged): if removing this
	...
	// dashboard and (worse) call write endpoints (Robert flagged).
	...
	// Batch 2: ALSO kill every dashboard session the removed
	...
	// for forensics. Batch 2 adds sessions_revoked.
