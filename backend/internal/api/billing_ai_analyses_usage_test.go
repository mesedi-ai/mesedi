// Unit tests for HandleGetAIAnalysesUsage (Mesedi #197).
//
...
//   - Hobby pay-per-use (#206) → Applicable=true, Limit=50, Count from
...
func TestHandleGetAIAnalysesUsage_Hobby_PayPerUse(t *testing.T) {
	// Pre-#30 (#206), Hobby flips from "gated entirely, Applicable=false"
...
func TestHandleGetAIAnalysesUsage_Team_WithinIncluded_OverageSpendIsZero(t *testing.T) {
	// #208: Team now surfaces PricePerAnalysisUSD as the OVERAGE
...
func TestHandleGetAIAnalysesUsage_Team_AboveIncluded_OverageSpendIsAccurate(t *testing.T) {
	// #208: When count > 200, EstimatedSpendUSD = (count - 200) *
