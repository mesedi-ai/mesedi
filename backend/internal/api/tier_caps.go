...
const (
	...
	// ─── Theme B detector-threshold tier caps ───────────────────
	//
	// Tier caps apply ONLY where raising the value maps to a real
	// cost or abuse vector. The other 9 Theme B thresholds are
	...
	// tier discrimination. Same doctrine as cost_velocity (Wave 0.1
