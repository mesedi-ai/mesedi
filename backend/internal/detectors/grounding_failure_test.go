// Unit tests for the grounding_failure detector (Mesedi #14).
//
// Fire conditions:
...
//   - DetectGroundingFailureAllMatchesWithThresholds: Wave G2 all-matches
//
// Per-evaluator floor map (Theme B extensions / G3) lets customers
...
// ─────────────────────────────────────────────────────────────────────
// DetectGroundingFailureAllMatchesWithThresholds (Wave G2)
// ─────────────────────────────────────────────────────────────────────
