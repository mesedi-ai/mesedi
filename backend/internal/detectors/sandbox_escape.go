...
var sandboxPatterns = mustCompilePatterns([]struct {
	...
	},
	{
		...
		// matching identifiers like `myFunction`.
		id:      "js_function_constructor",
		pattern: `(?:^|\W)(?:new\s+)?Function\s*\(\s*['"\x60]`,
	},
	{
	...
	},
	{
		...
		// be suspicious but is structurally a different host (
		// alert , go/regex-injection / regex-missing-anchor).
