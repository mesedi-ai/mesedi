...
# it never edits them.
#
# Pre-#283 this script pointed at mesedi/web-extract/ — a locally-
# maintained stale snapshot of the mesedi-web repo. Wave 3.F moved
...
# Wave 3.F: point at the sibling mesedi-web checkout rather than a
...
# Hobby execution limit: 5,000 (Wave 3.F cut from 10K, closes #284)
...
# Hobby LLM analysis per-period cap: 25 (Wave 3.F cut from 50, closes #284)
...
# Hobby retention default: 7 days (Wave 3.F cut from 15, closes
# #284 — PostHog-free benchmark). Constant in billing.go used by
...
# ─── Per-feature claim drift guards (Wave 3.F, closes #283) ────
#
# Pre-#283 this script only asserted pricing scalars. That let
...
# Hobby audit logs — Wave 3.F (#284 decision) moved to Team-only.
